...
initglobs0()
{
	...
	am_model.am_CONWIP_LIST = symGetSystemDataByName(am_model.$sys, "CONWIP_LIST");
	am_model.am_P_Enter_A = symGetSystemDataByName(am_model.$sys, "P_Enter_A");
	am_model.am_P_Pre_Enter = symGetSystemDataByName(am_model.$sys, "P_Pre_Enter");
	...
	am_model.am_j$att = symGetSystemDataByName(am_model.$sys, "j");
	...
	model_logic_init(&am_model);
	{
		...
		ffp_C__Users_Administrator_Desktop_Results_txt = IterValue(List, FileList, it);
	}
	{
