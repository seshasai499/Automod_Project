...
// Generated:	Sat Dec 14 03:08:15 2024
...
iofile* ffp_C__Users_Administrator_Desktop_Results_txt;	/* 'C:/Users/Administrator/Desktop/Results.txt */
...
get_ldatt_address(load* this, int32 index, int32* d)
{
	...
	case 1:
		...
		break;
	case 2:
		data = (void*)&this->attribute->am_model.am_j;
		break;
	}
	return data;
}
...
set_attdata(load* this)
{
	...
	am_model.am_j$att->data = (void*)&this->attribute->am_model.am_j;
}
