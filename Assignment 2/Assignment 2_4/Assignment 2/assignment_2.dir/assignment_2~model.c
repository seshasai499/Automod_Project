...
get_ldatt_address(load* this, int32 index, int32* d)
{
	...
	switch(index) {
	case 0:
		data = (void*)&this->attribute->am_model.am_Makespan;
		break;
	case 1:
		data = (void*)&this->attribute->am_model.am_RPT;
		break;
	case 2:
		data = (void*)&this->attribute->am_model.am_MakespanB;
		break;
	case 3:
		data = (void*)&this->attribute->am_model.am_loadptr;
		break;
	}
	return data;
}
...
set_attdata(load* this)
{
	...
	am_model.am_Makespan$att->data = (void*)&this->attribute->am_model.am_Makespan;
	am_model.am_RPT$att->data = (void*)&this->attribute->am_model.am_RPT;
	am_model.am_MakespanB$att->data = (void*)&this->attribute->am_model.am_MakespanB;
	am_model.am_loadptr$att->data = (void*)&this->attribute->am_model.am_loadptr;
}
