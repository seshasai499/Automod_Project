...
initglobs0()
{
	...
	am_model.am_stream_DiffR1_2 = symGetSystemDataByName(am_model.$sys, "stream_DiffR1_2");
	...
	am_model.am_stream_DiffR1_1 = symGetSystemDataByName(am_model.$sys, "stream_DiffR1_1");
	...
	am_model.am_stream_DiffR1_4 = symGetSystemDataByName(am_model.$sys, "stream_DiffR1_4");
	am_model.am_stream_LithR1_1 = symGetSystemDataByName(am_model.$sys, "stream_LithR1_1");
	...
	am_model.am_stream_LithR1_2 = symGetSystemDataByName(am_model.$sys, "stream_LithR1_2");
